<#######<Script>#######>
<#######<Header>#######>
# Name: Convert-ScriptToExe
# Copyright: Gerry Williams (https://www.gerrywilliams.net)
# License: MIT License (https://opensource.org/licenses/mit)
# Script Modified from: Ingo Karstein (http://blog.karstein-consulting.com) PS2EXE
<#######</Header>#######>
<#######<Body>#######>
...
#>
   ...
   Param
    (
        [Parameter(Position = 0, Mandatory = $true)][string]$inputFile = $null,
        [Parameter(Position = 1, Mandatory = $true)][string]$outputFile = $null, 
        [switch]$verbose,
        [switch] $debug, 
        [switch]$runtime20, 
        [switch]$x86,
        ...
        [String]$Logfile = "$PSScriptRoot\..\Logs\Convert-ScriptToExe.Log"
...
"@
        ...
        $referenceAssembies += ([System.AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.ManifestModule.Name -ieq "Microsoft.PowerShell.ConsoleHost" } | select -First 1).location
        ...
        if ( $noConsole )
        {
            ...
            $referenceAssembies += ([System.AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.ManifestModule.Name -ieq "System.Windows.Forms.dll" } | select -First 1).location
            $referenceAssembies += ([System.AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.ManifestModule.Name -ieq "System.Drawing.dll" } | select -First 1).location
        }
...
"@
        ...
        $configFileForEXE2 = `
            "<?xml version=""1.0"" encoding=""utf-8"" ?>`r`n<configuration><startup><supportedRuntime version=""v2.0.50727""/></startup></configuration>"
        $configFileForEXE3 = `
            "<?xml version=""1.0"" encoding=""utf-8"" ?>`r`n<configuration><startup><supportedRuntime version=""v4.0"" sku="".NETFramework,Version=v4.0"" /></startup></configuration>"
        #endregion
        ...
        else
        {
            ...
            if ( Test-Path $outputFile )
            {
                ...
                if ( $debug)
                {
                    $cr.TempFiles | Where-Object { $_ -ilike "*.cs" } | select -first 1 | ForEach-Object {
