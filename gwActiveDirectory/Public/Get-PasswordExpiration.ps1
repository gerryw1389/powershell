...
Function Get-PasswordExpiration
{
    <#
.Synopsis
Returns the password expiration for a given user. Must pass in the samaccountname.
.Description
Returns the password expiration for a given user. Must pass in the samaccountname.
.Example
Get-PasswordExpiration -Identity 'gerryw'
Returns the password expiration for 'gerryw'
#>
