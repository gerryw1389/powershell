<#######<Script>#######>
<#######<Header>#######>
# Name: Clear-ADUserEmailAddress
<#######</Header>#######>
<#######<Body>#######>
Function Clear-ADUserEmailAddress
{
    <#
.Synopsis
Removes 'EmailAddress' property for one or more AD Users.
.Description
Removes 'EmailAddress' property for one or more AD Users.
.Example
Clear-ADUserEmailAddress -Users 'gerryw', 'billyb'
Removes the 'emailAddress' property for AD Users 'gerryw' and 'billyb'
#>
