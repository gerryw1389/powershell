...
Function Start-SnakeGame
{
    ...
    Process
    {   
        Write-ToString "Be aware that the game usually starts unfocused. Just press enter (after your first death) to start a new game. Enjoy!"
        Write-ToString "All credits go to https://www.reddit.com/user/NuvolaGrande, I just wrote a wrapper function"
...
'@)
    ...
    End
    {
        Write-ToString "Unfortunately you have to close your Powershell session and recall the function if you want to play again." -Color Magenta
