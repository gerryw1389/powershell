...
<#######<Default Begin Block>#######>
        ...
        Catch
        {
            Write-ToString "Module 'Pscx' was not found, stopping script"
            Exit 1
        }
        ...
        Catch
        {
            Write-ToString "Module 'AWSPowerShell' was not found, stopping script"
            Exit 1
        }
    ...
    {    
        ...
        {
            $ItemName = $S.name
            Write-ToString "Uploading $ItemName"
