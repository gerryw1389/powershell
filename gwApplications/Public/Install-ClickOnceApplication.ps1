...
"@
    ...
    Process
    {   
        Write-ToString "Uninstalling App..."
        ...
        Write-ToString "Uninstalling App... Completed"
    
        Write-ToString "Renaming Localappdata-Apps-2.0 Folder..."
        ...
        If (Test-Path "C:\Users\$Env:Username\Appdata\Local\Apps\2.0.Old") 
        {
            ...
            Write-ToString "Renaming Localappdata-Apps-2.0 Folder...Completed"
        }
        Else 
        { 

            Write-ToString "Renaming Localappdata-Apps-2.0 Folder...Failed!"
        }

        Write-ToString "Reinstalling Application..."
