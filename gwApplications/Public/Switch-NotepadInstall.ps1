...
Function Switch-NotepadInstall
{
    ...
    {       
        ...
        Function Set-Ownership($File)
        {
            ...
            Catch
            {
                Write-Log "Failed To Take Ownership Of $File" 
            }
        }
    ...
    {   
        ...
        Foreach ($Notepad In $Notepads)
        {
            ...
            {
                Write-Log "Checking For The Required Paths Before Attempting Changes."
                Continue
            }
            ...
            Write-Log "Replacing Notepad File: $Notepad `R`N"
        ...
        & $Notepadplus
        Write-Log "Notepad Successfully Replaced With Notepad++"
