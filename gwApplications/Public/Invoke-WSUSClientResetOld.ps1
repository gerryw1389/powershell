...
Function Invoke-WSUSClientReset
{
    ...
    {   
        ...
        Write-Log "Setting Windows Update Server to: $Wuserver"
        ...
        Write-Log "Disabling driver updates from WU"
        ...
        Write-Log "Updating Policies"
        cmd /c "gpupdate"

        Write-Log "Stopping update services, removing download folders, and re-registering DLLs.."
        ...
        Write-Log "Starting services and requesting updates from the WSUS Server"
        Start-Service -Name "wuauserv"
    
        Write-Log "Moving WU into it's own svchost.exe process"
