...
Function Set-ServerTemplate
{
    ...
    {    
        ...
        Write-Log "Lockscreen suggestions, rotating pictures"
        ...
        Write-Log "Disable Internet Explorer Enhanced Security Configuration (IE ESC)"
...
"@
    ...
    {
        Stop-log
        Write-Log "Configuration Complete. Press any key to reboot the computer"
        cmd /c "Pause"
        Restart-Computer  
    }
