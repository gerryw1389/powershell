...
Function Add-PSModulePath
{
    ...
    {   
        ...
        {
            $P = ";" + $P
            Write-Log "Adding $P to PSModulePath"
    ...
    End
    {
        Write-Log "Make sure to restart powershell to see the new module path. Run '`$env:psmodulepath -split ';' to check"
        Write-Log "For a GUI version, run sysdm.cpl and go to Advanced - Environmental Variables - PSModulePath "
        Stop-log
    }
}
