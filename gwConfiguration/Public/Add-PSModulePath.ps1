...
Function Add-PSModulePath
{
    ...
    {   
        ...
        {
            $P = ";" + $P
            Write-ToString "Adding $P to PSModulePath"
    ...
    End
    {
        Write-ToString "Make sure to restart powershell to see the new module path. Run '`$env:psmodulepath -split ';' to check"
        Write-ToString "For a GUI version, run sysdm.cpl and go to Advanced - Environmental Variables - PSModulePath "
