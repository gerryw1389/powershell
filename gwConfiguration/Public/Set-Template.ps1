...
Function Set-Template
{
    ...
    {    
        ...
        Write-Output "Setting Checkboxes in Explorer"
        ...
        Write-Output "Microphone - This one, let the user choose"
...
"@
    ...
    End
    {
        Write-Output "Enabling System Restore and creating a checkpoint"
        ...
        Write-Output "Ignore the error"
        Set-Executionpolicy Remotesigned -Force | Out-Null
        
        Write-Output "Configuration Complete. You may want to reboot for all setting to fully take affect."
        cmd /c Pause
    }
...
Write-Output "Disabling Let Apps Access Camera"
...
Write-Output "Disabling WifiSense"
...
Write-Output "Unpinning all items on taskbar - Irreversible!"
...
Write-Output "Disable all apps from store, left disabled by default"		
SetReg -Path "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore" -Name "DisableStoreApps" -Value "1" 

Write-Output "Turn off Store, left disabled by default"
