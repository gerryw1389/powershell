...
Function Test-PSProfiles
{
    ...
    2018-06-17: v1.2 Updated template.
    ...
    {   
        Try
        {
            Write-ToString "Creating Powershell Profiles"
            ...
            If (-not(Test-Path $CurrentUserCurrentHost))
            {
                ...
                Write-ToString "Created file: $CurrentUserCurrentHost"
            }
            Else
            {
                Write-ToString "File Already exists: $CurrentUserCurrentHost"
            }
            ...
            If (-not(Test-Path $CurrentUserAllHost))
            {
                ...
                Write-ToString "Created file: $CurrentUserAllHost"
            }
            Else
            {
                Write-ToString "File Already exists: $CurrentUserAllHost"
            }
            ...
            If (-not(Test-Path $AllUsersCurrentHost))
            {
                ...
                Write-ToString "Created file: $AllUsersCurrentHost"
            }
            Else
            {
                Write-ToString "File Already exists: $AllUsersCurrentHost"
            }
            ...
            If (-not(Test-Path $AllUsersAllHost))
            {
                ...
                Write-ToString "Created file: $AllUsersAllHost"
            }
            Else
            {
                Write-ToString "File Already exists: $AllUsersAllHost"
            }
            ...
            If (-not(Test-Path $ISECurrentUserCurrentHost))
            {
                ...
                Write-ToString "Created file: $ISECurrentUserCurrentHost"
            }
            Else
            {
                Write-ToString "File Already exists: $ISECurrentUserCurrentHost"
            }
            ...
            If (-not(Test-Path $ISEAllUserAllHosts))
            {
                ...
                Write-ToString "Created file: $ISEAllUserAllHosts"
            }
            Else
            {
                Write-ToString "File Already exists: $ISEAllUserAllHosts"
            }
