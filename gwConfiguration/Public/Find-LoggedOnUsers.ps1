...
Function Find-LoggedOnUsers
{
    ...
    {   
        ...
        Write-Log "Running Query.Exe Against $ComputerName"
        ...
        If ($Users -Like "*No User Exists*")
        {
            ...
            Write-Log "There Were No Users Found Logged On $ComputerName"
        }
        Elseif ($Users -Like "*Error*")
        {
            # Handle Errored Returned By Query.
            # Returned: 'Error ...<Message>...'
            Write-Log "There Was An Error Running Query Against $ComputerName"
        }
        Elseif ($Users -Eq $Null -And $Erroractionpreference -Eq 'Silentlycontinue')
        {
            # Handle Null Output Called By -Erroraction.
            Write-Log "Error Action Has Supressed Output From Query.Exe. Results Were Null."
        }
        Else
        {
            Write-Log "Users Found On $ComputerName. Converting Output From Text."
            ...
            Write-Log "Generating Output For $($Users.Count) Users Connected To $ComputerName"
            ...
            Foreach ($User In $Users)
            {
                ...
                {
                    Write-Log "User found: $($User.Username)"
                }
