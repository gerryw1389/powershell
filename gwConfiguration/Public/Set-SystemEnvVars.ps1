...
Function Set-SystemEnvVar
{
   <#
    .Synopsis
    Sets an environmental variable for the "NT Authority\System" user. This is helpful if you run scripts as scheduled tasks that you want to store a password in.
    .Description
    Sets an environmental variable for the "NT Authority\System" user. This is helpful if you run scripts as scheduled tasks that you want to store a password in.
    .Example
    Set-SystemEnvVar
